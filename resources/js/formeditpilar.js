...
$.getJSON("/admin/bataspilar", function (geojsonData) {
    ...
    // Mengambil geometri dari fitur pertama
    var geometry = filteredFeatures[0].geometry;

    // Mengonversi geometri menjadi WKT
    var wkt = geojsonToWKT(geometry);

    // Mengambil elemen input form geom
    var inputGeom = document.getElementById("geom");

    // Memasukkan data WKT ke dalam input form geom
    inputGeom.value = wkt;
});
