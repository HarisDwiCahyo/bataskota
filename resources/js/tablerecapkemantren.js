...
document.addEventListener("DOMContentLoaded", function () {
    gridOptions = {
        ...
        columnDefs: [
            ...
            },
            {
                headerName: "Aksi",
                cellRenderer: function (params) {
                    var editUrl = "/admin/formeditkemantren/" + params.data.gid;
                    var kirimUrl = "/admin/kirimkemantren/" + params.data.gid;
                    var deleteUrl = "/admin/hapuskemantren/" + params.data.gid;
    ...
    document
        ...
        .addEventListener("click", function () {
            // Mengambil data GeoJSON dari endpoint '/kecamatan'
            $.getJSON("/admin/kecamatan", function (geojsonData) {
