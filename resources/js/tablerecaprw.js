...
document.addEventListener("DOMContentLoaded", function () {
    gridOptions = {
        ...
        columnDefs: [
            ...
            },
            {
                headerName: "Aksi",
                cellRenderer: function (params) {
                    var editUrl = "/admin/formeditrw/" + params.data.gid;
                    var kirimUrl = "/admin/kirimrw/" + params.data.gid;
                    var deleteUrl = "/admin/hapusrw/" + params.data.gid;
    ...
    document
        ...
        .addEventListener("click", function () {
            // Mengambil data GeoJSON dari endpoint '/rw'
            $.getJSON("/admin/rw", function (geojsonData) {
