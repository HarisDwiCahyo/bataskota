...
document.addEventListener("DOMContentLoaded", function () {
    gridOptions = {
        ...
        columnDefs: [
            ...
            },
            {
                headerName: "Aksi",
                cellRenderer: function (params) {
                    var editUrl = "/admin/formeditkota/" + params.data.gid;
                    var kirimUrl = "/admin/kirimkota/" + params.data.gid;
                    var deleteUrl = "/admin/hapuskota/" + params.data.gid;
    ...
    document
        ...
        .addEventListener("click", function () {
            // Mengambil data GeoJSON dari endpoint '/kota'
            $.getJSON("/admin/kota", function (geojsonData) {
