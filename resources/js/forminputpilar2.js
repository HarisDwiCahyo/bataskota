            ...
            if (isFeatureValid(transformedFeature)) {
                ...
                const isDuplicate = featureDataArray.some(
                    (existingFeature) =>
                        ...
                        existingFeature.kondisi ===
                            transformedFeature.kondisi &&
                        ...
                        existingFeature.perbatasan ===
                            transformedFeature.perbatasan &&
                        existingFeature.alamat === transformedFeature.alamat &&
                        existingFeature.pembuatan ===
                            transformedFeature.pembuatan &&
                        existingFeature.pemeliharaan ===
                            transformedFeature.pemeliharaan &&
...
function transformFeature(feature) {
    ...
    return {
        kemantren: attributes.kemantren ? [attributes.kemantren] : [null],
        kelurahan: attributes.kelurahan ? [attributes.kelurahan] : [null],
        kondisi: attributes.kondisi ? [attributes.kondisi] : [null],
        east: attributes.east ? [attributes.east] : [null],
        south: attributes.south ? [attributes.south] : [null],
        nopilar: attributes.nopilar ? [attributes.nopilar] : [null],
        easting: attributes.easting ? [attributes.easting] : [null],
        northing: attributes.northing ? [attributes.northing] : [null],
        up: attributes.up ? [attributes.up] : [null],
        peraturan: attributes.peraturan ? [attributes.peraturan] : [null],
        perbatasan: attributes.perbatasan ? [attributes.perbatasan] : [null],
        alamat: attributes.alamat ? [attributes.alamat] : [null],
        pemeliharaan: attributes.pemeliharaan
            ? [attributes.pemeliharaan]
            : [null],
        pembuatan: attributes.pembuatan ? [attributes.pembuatan] : [null],
        beritaacara: attributes.beritaacara ? [attributes.beritaacara] : [null],
...
function isFeatureValid(feature) {
    ...
    return (
        feature.kemantren !== undefined &&
        feature.kelurahan !== undefined &&
        feature.kondisi !== undefined &&
        ...
        feature.peraturan !== undefined &&
        feature.perbatasan !== undefined &&
        feature.alamat !== undefined &&
        feature.pemeliharaan !== undefined &&
        feature.pembuatan !== undefined &&
        feature.beritaacara !== undefined &&
...
function initializeGrid(featureDataArray) {
    ...
    const gridOptions = {
        ...
        columnDefs: [
            ...
            { headerName: "Kondisi", field: "kondisi" },
            ...
            { headerName: "Perbatasan", field: "perbatasan" },
            { headerName: "Alamat", field: "alamat" },
            { headerName: "Pemeliharaan", field: "pemeliharaan" },
            { headerName: "Pembuatan", field: "pembuatan" },
            { headerName: "Beritaacara", field: "beritaacara" },
