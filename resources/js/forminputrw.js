    ...
    try {
        ...
        features.forEach((feature) => {
            ...
            const isFeatureExists = featureDataArray.some((existingFeature) => {
                return (
                    existingFeature.NAMOBJ === transformedFeature.NAMOBJ &&
                    existingFeature.WADMKC === transformedFeature.WADMKC &&
                    existingFeature.WADMKK === transformedFeature.WADMKK &&
                    existingFeature.SRSID === transformedFeature.SRSID &&
                    existingFeature.KDCPUM === transformedFeature.KDCPUM &&
                    existingFeature.KDEPUM === transformedFeature.KDEPUM &&
                    existingFeature.WADRW === transformedFeature.WADRW &&
...
function transformFeature(feature) {
    ...
    return {
        NAMOBJ: attributes.NAMOBJ,
        WADMKC: attributes.WADMKC,
        WADMKK: attributes.WADMKK,
        SRSID: attributes.SRS_ID,
        KDCPUM: attributes.KDCPUM,
        KDEPUM: attributes.KDEPUM,
        WADRW: attributes.WADRW,
        geom: wkt,
    };
}
...
function initializeGrid(featureDataArray) {
    ...
    const gridOptions = {
        ...
        columnDefs: [
            { headerName: "NAMOBJ", field: "NAMOBJ" },
            { headerName: "WADMKC", field: "WADMKC" },
            { headerName: "WADMKK", field: "WADMKK" },
            { headerName: "SRSID", field: "SRSID" },
            { headerName: "KDCPUM", field: "KDCPUM" },
            { headerName: "KDEPUM", field: "KDEPUM" },
            { headerName: "WADRW", field: "WADRW" },
