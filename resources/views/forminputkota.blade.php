...
@section('mainsection')
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="page-title">
                        <h5 style="color: rgb(99, 99, 99); font-weight: bold">Form Input Kota</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form id="featureForm" action="{{ route('admin.storekota') }}" method="POST">
                    @csrf
                    <div class="card lobipanel-custom">
                        <div class="card-header">
                            <div class="card-title" style="color: rgb(95, 95, 95); font-weight: bold">Input Data Kota
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="form-inline" style="margin-left: 8px">
                                    ...
                                    <a href="{{ route('admin.forminputkota2') }}" class="btn btn-primary my-1 btn-custom"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header">
                        <div class="card-title" style="color: rgb(84, 84, 84); font-weight: bold">Tabel Kota</div>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(99, 99, 99); font-weight: bold">Peta Kota</div>
                    <div class="card-body">
                        <div id="map">
