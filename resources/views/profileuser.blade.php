            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="page-title">
                        <h5 style="color: rgb(81, 81, 81); font-weight: bold">Profil Pengguna</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                ...
                <form action="{{ route('admin.updateprofile', ['id' => $data['id']]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card lobipanel-custom">
                        <div class="card-header" style="color: rgb(93, 93, 93); font-weight: bold">Edit Profil</div>
                        <div class="card-body">
                            <div class="row gutters">
