    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-calendar3" style="color: rgb(100, 100, 100);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(94, 94, 94); font-weight: bold">Tabel Recap Kemantren</h5>
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(106, 106, 106); font-weight: bold">Historis Batas Kemantren
                    </div>
                    <div class="card-body">
