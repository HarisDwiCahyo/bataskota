    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-calendar3" style="color: rgb(92, 92, 92);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(108, 108, 108); font-weight: bold">Tabel Recap Kelurahan</h5>
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(96, 96, 96); font-weight: bold">Historis Batas Kelurahan
                    </div>
                    <div class="card-body">
