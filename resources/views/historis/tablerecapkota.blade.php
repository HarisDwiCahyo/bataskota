            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="page-title">
                        <h5 style="color: rgb(101, 101, 101); font-weight: bold">Tabel Recap Kota</h5>
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(103, 103, 103); font-weight: bold">Historis Batas Kota
                    </div>
                    <div class="card-body">
