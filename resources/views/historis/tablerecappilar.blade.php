    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-calendar3" style="color: rgb(89, 89, 89);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(101, 101, 101); font-weight: bold">Tabel Recap Pilar</h5>
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(99, 99, 99); font-weight: bold">Historis Pilar Batas</div>
                    <div class="card-body">
