...
@section('mainsection')
    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-documents2" style="color: rgb(89, 89, 89);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(91, 91, 91); font-weight: bold">Form Edit Kota</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form action="{{ route('admin.updatekota', ['id' => $data[0]['gid']]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card lobipanel-custom">
                        <div class="card-header" style="color: rgb(90, 90, 90); font-weight: bold">Edit Atribut Kota</div>
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kodekota" name="kodekota"
                                            placeholder="kodekota" value="{{ $data[0]['kodekota'] }}" />
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                            ...
                            <a href="{{ route('admin.tablerecapkota') }}" class="btn btn-primary my-1"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="font-weight: bold ; color: rgb(90, 90, 90)">Peta Data Kota</div>
                    <div class="card-body">
                        <div id="map">
