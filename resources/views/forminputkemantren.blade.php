...
@section('mainsection')
    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-browser2" style="color: rgb(107, 107, 107);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(103, 103, 103); font-weight: bold">Form Input Kemantren</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form id="featureForm" action="{{ route('admin.storekemantren') }}" method="POST">
                    @csrf
                    <div class="card lobipanel-custom">
                        <div class="card-header">
                            <div class="card-title" style="color: rgb(95, 95, 95); font-weight: bold">Input Data
                                Kemantren
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="form-inline" style="margin-left: 8px">
                                    ...
                                    <a href="{{ route('admin.forminputkemantren2') }}"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header">
                        <div class="card-title" style="color: rgb(91, 91, 91); font-weight: bold">Tabel Kemantren</div>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(98, 98, 98); font-weight: bold">Peta Kemantren</div>
                    <div class="card-body">
                        <div id="map">
