...
@section('mainsection')
    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-browser2" style="color: rgb(91, 91, 91);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(96, 96, 96); font-weight: bold">Formulir RW 2</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form id="featureForm" action="{{ route('admin.storerw2') }}" method="POST">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="form-inline" style="margin-left: 8px">
                                    ...
                                    <a href="{{ route('admin.forminputrw') }}" class="btn btn-primary my-1 btn-custom"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header">
                        <div class="card-title" style="color: rgb(89, 89, 89); font-weight: bold">Tabel RW</div>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(83, 83, 83); font-weight: bold">Peta RW</div>
                    <div class="card-body">
                        <div id="map">
