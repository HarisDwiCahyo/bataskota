...
@section('mainsection')
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="page-title">
                        <h5 style="color: rgb(99, 99, 99); font-weight: bold">Form Input Kemantren 2</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form id="featureForm" action="{{ route('admin.storekemantren2') }}" method="POST">
                    @csrf
                    <div class="card lobipanel-custom">
                        <div class="card-header">
                            <div class="card-title" style="color: rgb(90, 90, 90); font-weight: bold">Input Data
                                Kemantren
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(106, 106, 106); font-weight: bold">Peta Kemantren</div>
                    <div class="card-body">
                        <div id="map">
