...
@section('mainsection')
    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-browser2" style="color: rgb(99, 99, 99);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(99, 99, 99); font-weight: bold">Form Input Pilar</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form id="featureForm" action="{{ route('admin.storepilar') }}" method="POST">
                    @csrf
                    <div class="card lobipanel-custom">
                        <div class="card-header">
                            <div class="card-title" style="color: rgb(98, 98, 98); font-weight: bold">Input Data Pilar
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="form-inline" style="margin-left: 8px">
                                    ...
                                    <a href="{{ route('admin.forminputpilar2') }}" class="btn btn-primary my-1 btn-custom"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header">
                        <div class="card-title" style="color: rgb(109, 109, 109); font-weight: bold">Tabel Pilar
                        </div>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(99, 99, 99); font-weight: bold">Peta Pilar</div>
                    <div class="card-body">
                        <div id="map">
