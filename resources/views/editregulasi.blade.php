            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="page-title">
                        <h5 style="color: rgb(81, 81, 81); font-weight: bold">Edit Regulasi</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                ...
                <form action="{{ route('admin.updateregulasi', ['id' => $data[0]['id']]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card lobipanel-custom">
                        <div class="card-header" style="color: rgb(93, 93, 93); font-weight: bold">Ubah Regulasi</div>
                        <div class="card-body">
                            <div class="row gutters">
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="peraturan" name="peraturan"
                                            placeholder="peraturan" value="{{ $data[0]['perwal'] }}" required />
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" id="link" name="link"
                                            placeholder="link url" value="{{ $data[0]['link'] }}" required />
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        <label for="deskripsi">Deskripsi</label>
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" required>{{ $data[0]['deskripsi'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <a href="{{ route('admin.tableregulasi') }}" class="btn btn-primary my-1"
