    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-calendar3" style="color: rgb(105, 105, 105);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(101, 101, 101); font-weight: bold">Tabel Recap Kemantren</h5>
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(107, 107, 107); font-weight: bold">Data Batas Kemantren
                    </div>
                    <div class="card-body">
