...
@section('mainsection')
    ...
    <header class="main-heading">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <div class="page-icon">
                        <i class="icon-documents2" style="color: rgb(102, 102, 102);"></i>
                    </div>
                    <div class="page-title">
                        <h5 style="color: rgb(99, 99, 99); font-weight: bold">Form Edit RW</h5>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-sm-12">
                <form action="{{ route('admin.updaterw', ['id' => $data[0]['gid']]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card lobipanel-custom">
                        <div class="card-header" style="color: rgb(105, 105, 105); font-weight: bold">Edit Atribut RW</div>
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rw" name="rw"
                                            placeholder="rw" value="{{ $data[0]['rw'] }}" />
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                            ...
                            <a href="{{ route('admin.tablerecaprw') }}" class="btn btn-primary my-1"
            ...
            <div class="col-sm-12">
                <div class="card lobipanel-custom">
                    <div class="card-header" style="color: rgb(104, 104, 104); font-weight: bold">Peta Data RW</div>
                    <div class="card-body">
                        <div id="map">
